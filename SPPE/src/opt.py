...
parser = argparse.ArgumentParser(description='PyTorch CVC-Net Training')

"----------------------------- General options -----------------------------"
parser.add_argument('--expID', default='default', type=str,
                    help='Experiment ID')
parser.add_argument('--dataset', default='mpii', type=str,
...
parser.add_argument('--nClasses', default=16, type=int,
...
parser.add_argument('--outputResH', default=64, type=int,
                    help='Output heatmap height')
parser.add_argument('--outputResW', default=48, type=int,
