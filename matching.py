# -----------------------------------------------------
# Copyright (c) University of Shanghai for Science and Technology. All rights reserved.
# Date: 2020.01.25
# -----------------------------------------------------
...
def candidate_reselect(bboxes, bboxes_scores, pose_preds):
    ...
    for n, person in pose_preds.items():
        ...
        final_pose = torch.zeros(33, 2)
        final_score = torch.zeros(33, 1)
